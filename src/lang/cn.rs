...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 联端控制 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 联端控制 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 联端控制 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 联端控制 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 联端控制 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [联端控制 Input] 服务开启。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持 联端控制 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 联端控制 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 联端控制 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 联端控制 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 联端控制 的 UAC 窗口点击确认。"),
        ...
        ("verify_rustdesk_password_tip", "验证 联端控制 密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 联端控制 启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，联端控制 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 联端控制 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 联端控制 后台服务"),
        ...
        ("Upload folder", "上传文件夹"),
        ("Upload files", "上传文件"),
        ("Drop files to upload to remote", "松开以上传到远程设备"),
        ("Uploading files to Mac", "正在上传到 Mac"),
        ("Uploaded files to Mac", "已上传 {} 个文件到 Mac"),
        ("Remote upload is already running", "正在上传远程文件"),
        ("Remote drop upload supports Mac only", "拖入直传目前仅支持 Mac"),
        ("Remote drop upload failed", "拖入直传失败"),
        ("Direct upload failed, opening file transfer", "直传失败，正在打开文件传输"),
        ("Opening file transfer for upload", "正在打开文件传输并上传"),
        ("Upload started", "已开始上传"),
        ("Upload failed", "上传失败"),
        ("No valid files to upload", "没有可上传的有效文件"),
        ("Download selected files", "下载选中文件"),
        ("File copy and paste is not available", "文件复制粘贴不可用，请先更新或重装 Mac 端"),
        ("File download is only available in remote control sessions", "只有远程控制会话里才能下载文件"),
        ("Remote file permission is disabled", "远程设备没有开启文件权限"),
        ("Remote keyboard control is not available", "远程键盘控制不可用"),
        ("Local file clipboard is not available", "本机文件剪贴板不可用"),
        ("Remote Mac needs UniLink Control update for file download", "远程 Mac 需要更新 UniLink Control 才能下载文件"),
        ("View-only mode cannot download files", "仅观看模式不能下载文件"),
        ("Copied remote selection. Paste it in Windows to download.", "已复制远程选中文件，请在 Windows 文件夹中粘贴下载"),
        ("Downloading remote selection", "正在下载远程选中文件"),
        ("Remote selection downloaded", "已下载 {} 个项目"),
        ("Remote selection download failed", "远程选中文件下载失败"),
        ("Remote selection download is already running", "正在下载远程选中文件"),
        ("Remote selection download supports Mac only", "远程选中文件下载目前仅支持 Mac"),
        ("Select files in Finder first", "请先在 Mac Finder 里选中文件"),
        ("Finder selection is not available", "无法读取 Finder 选中文件"),
        ("Remote files are ready", "远程文件已就绪"),
        ("Drag files out", "拖出文件"),
        ("Prepare drag out", "先在 Mac 选中文件，再点这里"),
        ("Preparing remote files", "正在准备远程文件"),
        ("Remote files ready to drag", "文件已可拖出"),
        ("Drag to Windows", "拖到 Windows"),
        ("Dragging files out", "正在拖出文件"),
        ("Drag files out failed", "拖出文件失败"),
        ("Mac window mode", "Mac 窗口模式"),
        ("Extract Mac window", "提取 Mac 窗口"),
        ("Mac window mode supports Mac only", "Mac 窗口模式目前仅支持 Mac"),
        ("Mac window mode failed", "Mac 窗口模式失败"),
        ("Mac window activated", "已切到这个 Mac 窗口"),
        ("No Mac windows found", "没有找到 Mac 窗口"),
        ("Open an app window on Mac and refresh.", "请先在 Mac 上打开一个应用窗口，然后刷新"),
        ("Choose a Mac window to prepare seamless mode.", "选择一个 Mac 窗口，作为无缝模式的目标"),
        ("Choose a Mac window to extract.", "选择一个要从 Mac 里拿出来的窗口"),
        ("Bring to front", "切到前台"),
        ("Open as separate window", "打开独立窗口"),
        ("Extract this window", "提取这个窗口"),
        ("Mac window mode window opened", "已打开 Mac 窗口模式"),
        ("Mac window extracted", "已提取 Mac 窗口"),
        ("Mac window mode preview", "Mac 窗口模式预览"),
        ("Mac accessibility permission is required", "Mac 需要开启辅助功能权限"),
        ("Check Mac permissions", "检查 Mac 权限"),
        ("Mac permission check", "Mac 权限检查"),
        ("Mac permission check failed", "Mac 权限检查失败"),
        ("Use the shown Mac user for SSH. Remote Login should be On, and the System Events test should return a number.", "SSH 用户名请使用这里显示的 Mac 短用户名；Remote Login 应为 On；System Events 测试应返回数字。"),
        ("No diagnostic output", "没有诊断输出"),
        ("Open folder", "打开文件夹"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 联端控制 客户端升级至版本 {} 或更新版本！"),
        ...
        ("Recent", "最近"),
        ("My Devices", "我的设备"),
        ("Set admin token to show My Devices.", "设置管理员令牌后显示我的设备。"),
        ("No enrolled devices yet.", "还没有已绑定设备。"),
        ("Edit Device", "编辑设备"),
        ("Device alias", "设备别名"),
        ("Delete device", "删除设备"),
        ("Delete this device from My Devices?", "确定要从我的设备中删除这个设备吗？"),
        ("This only removes the saved device entry.", "这只会删除已保存的设备记录，不会卸载对方设备上的软件。"),
        ("Device deleted", "设备已删除"),
        ("Device hidden locally", "设备已从本机列表隐藏"),
        ("Tags", "标签"),
        ("Notes", "备注"),
        ("Edit", "编辑"),
        ("Save", "保存"),
        ...
        ("Enrolled", "已绑定"),
        ("Not enrolled", "未绑定"),
        ("Enter enrollment token to add this device.", "输入绑定令牌以添加这台设备。"),
        ("Enrolled, waiting for first heartbeat.", "已绑定，正在等待首次心跳。"),
        ("Last heartbeat", "最后心跳"),
        ("Enrollment token is required", "请输入绑定令牌"),
        ("Hanako Control enrollment cleared", "联端控制绑定已清除"),
        ("Enrollment token", "绑定令牌"),
        ("Enrolled by", "绑定人"),
        ("Admin token", "管理员令牌"),
        ("Used to show My Devices.", "用于显示我的设备。"),
        ("Enrollment token label", "绑定令牌标签"),
        ("Generate enrollment token", "生成绑定令牌"),
        ("Never seen", "从未在线"),
        ("Online", "在线"),
        ("min ago", "分钟前"),
        ("h ago", "小时前"),
        ("d ago", "天前"),
        ("Request failed", "请求失败"),
        ("Enrollment response is incomplete", "绑定响应不完整"),
        ("Admin token is not configured", "请先设置管理员令牌"),
        ("Enrollment token response is incomplete", "绑定令牌响应不完整"),
        ("api-server is not configured", "请先设置 API 服务器"),
        ("Device ID is not ready", "设备 ID 尚未就绪"),
        ("UniLink Control", "联端控制"),
        ("No downloadable files were selected", "所选内容中没有可下载的文件"),
        ("Remote Control", "远程控制"),
        ("UniLink will select the best available connection.", "UniLink 会选择当前最合适的可用连接方式。"),
        ("Checking available connections...", "正在检查可用连接..."),
        ("Ready to try", "可以尝试连接"),
        ("Available on local network", "局域网内可用"),
        ("UniLink Control enrollment cleared", "联端控制绑定已清除"),
        ("UniLink Drive", "联端磁盘"),
        ("Mount drive", "挂载磁盘"),
        ("Disconnect drive", "断开磁盘"),
        ("Open drive", "打开磁盘"),
        ("Remote host", "远程地址"),
        ("Drive letter", "盘符"),
        ("Share name", "共享名"),
        ("Windows only", "仅支持 Windows"),
        ("UniLink Drive is available on Windows in this version.", "此版本仅支持在 Windows 使用联端磁盘。"),
        ("Mount failed", "挂载失败"),
        ("Mounted", "已挂载"),
        ("Not mounted", "未挂载"),
        ("Drive disconnected", "磁盘已断开"),
        ("Auto mount after connection", "连接后自动挂载"),
        ("Remote drive mounted", "远程磁盘已挂载"),
        ("Remote SMB is not reachable", "远程 SMB 不通"),
        ("Drive letter already in use", "盘符已被占用"),
        ("SSH", "SSH"),
        ("Checking SSH...", "正在检测 SSH..."),
        ("SSH is not reachable", "SSH 不通"),
        ("Connecting to SSH", "正在连接 SSH"),
        ("SSH connected", "SSH 已连接"),
        ("SSH disconnected", "SSH 已断开"),
        ("SSH connection failed", "SSH 连接失败"),
        ("SSH host key changed", "SSH 主机指纹已变化"),
        ("SSH authentication failed", "SSH 认证失败"),
        ("SSH Login", "SSH 登录"),
        ("Edit SSH login", "编辑 SSH 登录"),
        ("Tried SSH user", "已尝试 SSH 用户"),
        ("Check the Mac short username, Mac login password, and Remote Login permission.", "请确认 Mac 短用户名、Mac 登录密码，以及“远程登录”已允许这个用户。"),
        ("Enter the Mac login password once. UniLink will save it and use SSH automatically next time.", "输入一次 Mac 登录密码。UniLink 会保存它，下次自动用 SSH 获取窗口。"),
        ("Save and test", "保存并测试"),
        ("Testing SSH...", "正在测试 SSH..."),
        ("SSH login saved", "SSH 登录已保存"),
        ("Invalid SSH port", "SSH 端口无效"),
        ("Username is required", "用户名不能为空"),
        ("Connect via public server", "通过公共服务器连接"),
        ("Public server", "公共服务器"),
        ("Remote host is not available", "远程地址不可用"),
        ("Expected a JSON object response", "服务器返回的不是有效对象"),
        ("Expected a JSON list response", "服务器返回的不是有效列表"),
        ("Expected every list item to be a JSON object", "服务器列表数据格式不正确"),
    ].iter().cloned().collect();
}
