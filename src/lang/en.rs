...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the UniLink Control network..."),
        ...
        ("Drop files to upload to remote", "Drop files to upload to remote"),
        ("Uploading files to Mac", "Uploading files to Mac"),
        ("Uploaded files to Mac", "Uploaded {} file(s) to Mac"),
        ("Remote upload is already running", "Remote upload is already running"),
        ("Remote drop upload supports Mac only", "Remote drop upload supports Mac only"),
        ("Remote drop upload failed", "Remote drop upload failed"),
        ("Direct upload failed, opening file transfer", "Direct upload failed, opening file transfer"),
        ("Opening file transfer for upload", "Opening file transfer for upload"),
        ("Upload started", "Upload started"),
        ("Upload failed", "Upload failed"),
        ("No valid files to upload", "No valid files to upload"),
        ("Download selected files", "Download selected files"),
        ("File copy and paste is not available", "File copy and paste is not available"),
        ("File download is only available in remote control sessions", "File download is only available in remote control sessions"),
        ("Remote file permission is disabled", "Remote file permission is disabled"),
        ("Remote keyboard control is not available", "Remote keyboard control is not available"),
        ("Local file clipboard is not available", "Local file clipboard is not available"),
        ("Remote Mac needs UniLink Control update for file download", "Remote Mac needs UniLink Control update for file download"),
        ("View-only mode cannot download files", "View-only mode cannot download files"),
        ("Copied remote selection. Paste it in Windows to download.", "Copied remote selection. Paste it in Windows to download."),
        ("Downloading remote selection", "Downloading remote selection"),
        ("Remote selection downloaded", "{} item(s) downloaded"),
        ("Remote selection download failed", "Remote selection download failed"),
        ("Remote selection download is already running", "Remote selection download is already running"),
        ("Remote selection download supports Mac only", "Remote selection download supports Mac only"),
        ("Select files in Finder first", "Select files in Finder first"),
        ("Finder selection is not available", "Finder selection is not available"),
        ("Remote files are ready", "Remote files are ready"),
        ("Drag files out", "Drag files out"),
        ("Prepare drag out", "Select files on the Mac, then prepare drag out"),
        ("Preparing remote files", "Preparing remote files"),
        ("Remote files ready to drag", "Remote files ready to drag"),
        ("Drag to Windows", "Drag to Windows"),
        ("Dragging files out", "Dragging files out"),
        ("Drag files out failed", "Drag files out failed"),
        ("Mac window mode", "Mac window mode"),
        ("Extract Mac window", "Extract Mac window"),
        ("Mac window mode supports Mac only", "Mac window mode supports Mac only"),
        ("Mac window mode failed", "Mac window mode failed"),
        ("Mac window activated", "Mac window activated"),
        ("No Mac windows found", "No Mac windows found"),
        ("Open an app window on Mac and refresh.", "Open an app window on Mac and refresh."),
        ("Choose a Mac window to prepare seamless mode.", "Choose a Mac window to prepare seamless mode."),
        ("Choose a Mac window to extract.", "Choose a Mac window to extract."),
        ("Bring to front", "Bring to front"),
        ("Open as separate window", "Open as separate window"),
        ("Extract this window", "Extract this window"),
        ("Mac window mode window opened", "Mac window mode window opened"),
        ("Mac window extracted", "Mac window extracted"),
        ("Mac window mode preview", "Mac window mode preview"),
        ("Mac accessibility permission is required", "Mac Accessibility permission is required"),
        ("Check Mac permissions", "Check Mac permissions"),
        ("Mac permission check", "Mac permission check"),
        ("Mac permission check failed", "Mac permission check failed"),
        ("Use the shown Mac user for SSH. Remote Login should be On, and the System Events test should return a number.", "Use the shown Mac user for SSH. Remote Login should be On, and the System Events test should return a number."),
        ("No diagnostic output", "No diagnostic output"),
        ...
        ("install_tip", "Due to UAC, UniLink Control can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install UniLink Control to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant UniLink Control \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant UniLink Control \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow UniLink Control to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [UniLink Control Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next UniLink Control application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant UniLink Control \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant UniLink Control \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running UniLink Control."),
        ...
        ("verify_rustdesk_password_tip", "Verify UniLink Control password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use UniLink Control and start the service, do not proceed and hang up immediately."),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent UniLink Control from running properly as controlled side."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if UniLink Control window is open"),
        ...
        ("floating_window_tip", "It helps to keep UniLink Control background service"),
        ("About RustDesk", "About UniLink Control"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the UniLink Control client to version {} or newer on the remote side!"),
        ...
        ("More", "More"),
        ("Connect via public server", "Connect via public server"),
        ("Public server", "Public server"),
        ("UniLink Control", "UniLink Control"),
        ("No downloadable files were selected", "No downloadable files were selected"),
        ("Remote Control", "Remote Control"),
        ("UniLink will select the best available connection.", "UniLink will select the best available connection."),
        ("Checking available connections...", "Checking available connections..."),
        ("Ready to try", "Ready to try"),
        ("Available on local network", "Available on local network"),
        ("UniLink Control enrollment cleared", "UniLink Control enrollment cleared"),
        ("Delete device", "Delete device"),
        ("Delete this device from My Devices?", "Delete this device from My Devices?"),
        ("This only removes the saved device entry.", "This only removes the saved device entry. It does not uninstall the app on the remote device."),
        ("Device deleted", "Device deleted"),
        ("Device hidden locally", "Device hidden locally"),
        ("UniLink Drive", "UniLink Drive"),
        ...
        ("UniLink Drive is available on Windows in this version.", "UniLink Drive is available on Windows in this version."),
        ("Mount failed", "Mount failed"),
        ("Mounted", "Mounted"),
        ("Not mounted", "Not mounted"),
        ("Drive disconnected", "Drive disconnected"),
        ("Auto mount after connection", "Auto mount after connection"),
        ("Remote drive mounted", "Remote drive mounted"),
        ("Remote SMB is not reachable", "Remote SMB is not reachable"),
        ("Drive letter already in use", "Drive letter already in use"),
        ("SSH", "SSH"),
        ("Checking SSH...", "Checking SSH..."),
        ("SSH is not reachable", "SSH is not reachable"),
        ...
        ("SSH Login", "SSH Login"),
        ("Edit SSH login", "Edit SSH login"),
        ("Tried SSH user", "Tried SSH user"),
        ("Check the Mac short username, Mac login password, and Remote Login permission.", "Check the Mac short username, Mac login password, and Remote Login permission."),
        ("Enter the Mac login password once. UniLink will save it and use SSH automatically next time.", "Enter the Mac login password once. UniLink will save it and use SSH automatically next time."),
        ("Save and test", "Save and test"),
        ("Testing SSH...", "Testing SSH..."),
        ("SSH login saved", "SSH login saved"),
        ("Invalid SSH port", "Invalid SSH port"),
        ("Username is required", "Username is required"),
        ("Remote host is not available", "Remote host is not available"),
    ].iter().cloned().collect();
}
