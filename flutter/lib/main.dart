...
void runMainApp(bool startService) async {
  ...
  unawaited(hanakoControlClient.startHeartbeatLoop());
  ...
  switch (appType) {
    case kAppTypeDesktopRemote:
      ...
      if (argument['screen_rect'] == null) {
        final preferredContentSize = parseParamUniLinkMacWindowContentSize(
            argument['unilink_mac_window']);
        if (preferredContentSize == null) {
          ...
          await setNewConnectWindowPreferredContentSize(
              kWindowId!, preferredContentSize);
        }
      }
      break;
    case kAppTypeDesktopFileTransfer:
