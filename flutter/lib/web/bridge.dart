...
class RustdeskImpl {
  ...
  String mainGetEncryptedLocalOption({required String key, dynamic hint}) {
  ...
  Future<void> mainSetEncryptedLocalOption(
      {required String key, required String value, dynamic hint}) {
    return mainSetLocalOption(key: key, value: value, hint: hint);
  }
