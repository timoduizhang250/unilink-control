...
import '../../hanako/endpoint_resolver.dart';
import '../../hanako/ssh_terminal.dart';
...
abstract class BasePeerCard extends StatelessWidget {
  ...
  @protected
  MenuEntryBase<String> _sshAction(BuildContext context) {
    return MenuEntryButton<String>(
      childBuilder: (TextStyle? style) => Text(
        translate('SSH'),
        style: style,
      ...
      proc: () {
        showUniLinkSshTerminal(target: _peerEndpointTarget());
      },
      padding: menuPadding,
      dismissOnClicked: true,
    );
  ...
  UniLinkEndpointTarget _peerEndpointTarget() {
    return UniLinkEndpointTarget(
      peerId: peer.id,
      label: peer.alias.isNotEmpty ? peer.alias : peer.id,
