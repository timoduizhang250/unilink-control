  ...
  _FileManagerTabPageState(Map<String, dynamic> params) {
    ...
    tabController.add(TabInfo(
        ...
        page: FileManagerPage(
          ...
          pendingUploadPaths: _stringList(params['pendingUploadPaths']),
        )));
  }
  ...
  void initState() {
    ...
    rustDeskWinManager.setMethodHandler((call, fromWindowId) async {
      ...
      if (call.method == kWindowEventNewFileTransfer) {
        ...
        final id = args['id'];
        final pendingUploadPaths = _stringList(args['pendingUploadPaths']);
        windowOnTop(windowId());
        final existingPage = tabController.widget(id);
        if (existingPage is FileManagerPage) {
          existingPage.enqueuePendingUploadPaths(pendingUploadPaths);
          return tabController.jumpToByKey(id);
        }
        tabController.add(TabInfo(
            key: id,
            label: id,
