...
class TerminalModel with ChangeNotifier {
  ...
  final bool headless;
  final VoidCallback? onHeadlessOpened;
  final void Function(String text)? onHeadlessData;
  final void Function(int exitCode)? onHeadlessClosed;
  final void Function(String message)? onHeadlessError;
  ...
  TerminalModel(
    ...
    this.terminalId = 0,
    this.headless = false,
    this.onHeadlessOpened,
    this.onHeadlessData,
    this.onHeadlessClosed,
    this.onHeadlessError,
  }) : id = parent.id {
  ...
  void _handleTerminalOpened(Map<String, dynamic> evt) {
    ...
    if (success) {
      ...
      onHeadlessError?.call(
        message.isEmpty ? 'Failed to open terminal' : message,
      );
  ...
  void _handleTerminalClosed(Map<String, dynamic> evt) {
    ...
    onHeadlessClosed?.call(exitCode);
