...
class CanvasModel with ChangeNotifier {
  ...
  Rect? _remoteViewRect;
  bool _remoteViewRectServerCropped = false;
  ...
  Rect? get remoteViewRect => _remoteViewRect;
  bool get remoteViewRectServerCropped => _remoteViewRectServerCropped;
  ...
  bool setRemoteViewRect(Rect? rect, {bool serverCropped = false}) {
    final next = _normalizeRemoteViewRect(rect);
    final nextServerCropped = next != null && serverCropped;
    if (next == _remoteViewRect &&
        nextServerCropped == _remoteViewRectServerCropped) {
      return false;
    }
    _remoteViewRect = next;
    _remoteViewRectServerCropped = nextServerCropped;
    _resetScroll();
    return true;
  }

  Rect? _normalizeRemoteViewRect(Rect? rect) {
  ...
  int getDisplayWidth() {
    ...
    final remoteViewRect = _remoteViewRect;
    if (remoteViewRect != null && remoteViewRect.width > 0) {
      return max(1, remoteViewRect.width.round());
    }
  ...
  int getDisplayHeight() {
    ...
    final remoteViewRect = _remoteViewRect;
    if (remoteViewRect != null && remoteViewRect.height > 0) {
      return max(1, remoteViewRect.height.round());
    }
  ...
  clear() {
    ...
    _y = 0;
    _scale = 1.0;
    _remoteViewRect = null;
    _remoteViewRectServerCropped = false;
