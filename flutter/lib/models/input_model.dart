...
class InputModel {
  ...
  void onPointerSignalImage(PointerSignalEvent e) {
    ...
    if (e is PointerScrollEvent) {
      if (parent.target?.canvasModel.remoteViewRect != null &&
  ...
  Point? handlePointerDevicePos(
    ...
    CanvasCoords canvas = CanvasCoords.fromCanvasModel(canvasModel);
    Rect? rect = canvasModel.remoteViewRect ?? ffiModel.rect;

    if (isMove && canvasModel.remoteViewRect == null) {
